...
class ECBAESDecryptor {
  ...
  decrypt (inputArrayBuffer, offset, iv, removePKCS7Padding) {
    // let removePKCS7Padding = false;
    ...
    while (offset < inputInt32.length) {
      ...
      // Write
      outputInt32[offset] = swapWord(t0);
      outputInt32[offset + 1] = swapWord(t3);
      outputInt32[offset + 2] = swapWord(t2);
      outputInt32[offset + 3] = swapWord(t1);
...
export default ECBAESDecryptor;
